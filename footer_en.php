        ...
        <div class="footer_inner">
            ...
            <div class="link_box">
                <ul class="link_list clearfix">
                    <li class="privacy"><a href="/member/policy_en.php" class="link">Personal information <br>handling regulation</a></li>
                    <!--<li><a href="#" class="link">이용약관</a></li>-->
                    <li><a href="/member/emailCollectionRefuse_en.php" class="link">Refusal of email collections <br>without permission</a></li>
					<?if($GBL_USERID){?>
					<li><a href="/module/login/logout_proc.php" id="admLogout" class="link">manager logout</a></li>
					<?}?>
                </ul>
				
                <a id="familySite" class="family_site" href="/sub07/sub02_en.php">
                    <button type="button" id="btnFamilySite" class="btn_family_site"><span class="engFont"><!--Online estimation-->Contact</span></button>
                </a>
            </div>
            ...
            <div class="info_box">
                ...
                <div class="info">
                    <p>20, Chogwangsandan-ro, Hanam-si, Gyeonggi-do, Republic of Korea</p>
                    <p>Business Registration Number : 101-81-61162</p>
...
<div id="GblNotice" class="popup_background" style="min-width:250px;display:none;">
	...
	<div class="popup_notice">
		<div class="clearfix"><div class="img_clear"><img src="/module/popupoverlay/ico_notice.gif" alt="알림"></div><div class="pop_ttl0">notice</div></div>
...
<div id="conFirm" class="popup_background" style="min-width:250px;display:none;">
	...
	<div class="popup_notice">
		<div class="clearfix"><div class="img_clear"><img src="/module/popupoverlay/ico_notice.gif" alt="확인"></div><div class="pop_ttl0">confirm</div></div>
		<div class="pop_div_dotted"></div>
		<div class="write_it"><span id="confirmTxt" ></span></div>
		<a class="conFirm_close" href="#">
			<div class="btn2_wrap">
				<div class="btn_ali_pop3" id="confirmCancelBtn"><input type="button" class="btn_notice_reg_cancel" value="cancel" /></div>
				<div class="btn_ali_pop3" id="confirmBtn"><input type="button" class="btn_notice_reg_add" value="confirm"></div>
			</div>
		</a>
	</div>
</div>
