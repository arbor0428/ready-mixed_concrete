...
<!doctype html>
	<html lang="ko">
		<head>
			...
			<?
				include "/home/hkone/www/module/login/metaTag_en.php";
			?>
			

			<link rel="stylesheet" type="text/css" href="/css/reset_en.css?v=2">
			<link rel="stylesheet" type="text/css" href="/css/style_en.css?v=1">
			<link rel="stylesheet" type="text/css" href="/css/sub_en.css?v=2">
			<link rel="stylesheet" type="text/css" href="/css/mediaquery_en.css?v=4">
			
			
			<!--<link rel="stylesheet" type="text/css" href="/css/sub02.css">-->
			
			<link rel="stylesheet" type="text/css" href="/css/board_en.css?v=2">
