<style>
.member-area {font-size:1.125rem; line-height:1.5;}
...
<div class="member-area">
	흥국산업주식회사에서는 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.<br>
	...
	ο  본 방침은 : 2016 년 07 월 01 일 부터 시행됩니다.<br><br>

	<h3>수집하는 개인정보 항목</h3>
	회사는 상담 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.<br>
	- 수집항목 : 이름, 업체명, 연락처, 팩스번호, 이메일, 상담내용<br>
	- 개인정보 수집방법 : 홈페이지(사업의뢰)<br><br>
	...
	<h4>보존 항목 및 결제기록 보존 근거</h4>

	- 계약 또는 청약철회 등에 관한 기록 보존 기간 : 3년<br>
...
별도 DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는 보유되어지는 이외의 다른 목적으로 이용되지 않습니다.<br>
	...
	이용자들이 사전에 동의한 경우 법령의 규정에 의거하거나, 수사 목적으로 법령에 정해진 절차와 방법에 따라 수	사기관의 요구가 있는 경우
	<br><br>
	...
	부서명 : 영업지원팀<br>
	전화번호 : 02-427-2886<br>
	이메일 : Winnie@naver.com<br><br>

	<h4>개인정보관리 책임자</h4>

	성명 : 조정호<br>
	전화번호 : 02-427-2812<br>
	이메일 : join@hkone.co.kr<br><br>
